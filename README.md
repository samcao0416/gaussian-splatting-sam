...
This repository contains the modified version of the official implementation associated with the paper "3D Gaussian Splatting for Real-Time Radiance Field Rendering", which can be found [here](https://repo-sam.inria.fr/fungraph/3d-gaussian-splatting/)

This is the Depth branch. This branch will need depth image as input. For now, the depth image is 8-bit png file. "make-depth.py" can be used to generate the desired depth images.
...
The submodules in the original repository are removed. This repo has already integrated the submodules with the correct version, including 0.9.9.8 glm. The GLM repo was updated to 1.0.0 after 4 years of inactivity. During the test, this newer version may not work properly with the current codebase in Win11. The rendered image will be black. Thus, all the submodules are integrated with the correct version. 

## Overview

The codebase has 4 main components:
- A PyTorch-based optimizer to produce a 3D Gaussian model from SfM inputs and LiDAR inputs.
- A network viewer that allows to connect to and visualize the optimization process (Not Available in this repo).
- An OpenGL-based real-time viewer to render trained models in real-time.
- A script to help you turn your own images into optimization-ready SfM data sets. Scripts for turning Agi output results to colmap format are in [here](https://github.com/samcao0416/LargeScenePaperTools).

The components have different requirements w.r.t. both hardware and software. They have been tested on Windows 11 and Ubuntu Linux 20.04 and 18.04. Instructions for setting up and running each of them are found in the sections below.
...
conda install cudatoolkit=11.8 ( not necessary if you have installed CUDA 11.8)
